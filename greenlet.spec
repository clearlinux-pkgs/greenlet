...
%prep
%setup -q -n greenlet-1.1.1
cd %{_builddir}/greenlet-1.1.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1628728285
...
cp %{_builddir}/greenlet-1.1.1/LICENSE %{buildroot}/usr/share/package-licenses/greenlet/a0e4f5029d9a146a57a24b0c2a4615078bc1d759
cp %{_builddir}/greenlet-1.1.1/LICENSE.PSF %{buildroot}/usr/share/package-licenses/greenlet/c0710216ad228c4f1738a3212542f827d6fec097
