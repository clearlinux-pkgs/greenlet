...
%prep
%setup -q -n greenlet-1.0.0
cd %{_builddir}/greenlet-1.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1615911815
...
cp %{_builddir}/greenlet-1.0.0/LICENSE %{buildroot}/usr/share/package-licenses/greenlet/a0e4f5029d9a146a57a24b0c2a4615078bc1d759
cp %{_builddir}/greenlet-1.0.0/LICENSE.PSF %{buildroot}/usr/share/package-licenses/greenlet/c0710216ad228c4f1738a3212542f827d6fec097
